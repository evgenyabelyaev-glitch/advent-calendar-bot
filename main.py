...
ADVENT_MESSAGES = {
    ...
    26: "Декабрь закончился и за это время накопилось много всего. Твоё задание на сегодня: вспомни и напиши мне один поступок или слово, которое я сделал в этом месяце и от которого тебе стало по-настоящему тепло. Это будет моим лучшим подарком на сегодня✨❤️",
