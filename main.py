...
ADVENT_MESSAGES = {
    ...
    5: "☕️ Задание дня: Сделай себе самый уютный зимний напиток (чай, какао, кофе) и выпей его, думая о чём-то очень хорошем. 🍵",
    6: "",
    7: "",
    8: "",
    ...
    11: "🏞 Послание на 11-е: Представь, что мы сейчас гуляем в самом красивом месте. С тобой я готов на любые пейзажи.",
    ...
    19: "🎨 Послание на 19-е: ",
    20: "🕰 Послание на 20-е: Время, проведенное с тобой самое лучшее!",
    21: "🌳 Послание на 21-е: ",
    ...
    29: "🗺 Послание на 29-е: Куда бы ни привела нас жизнь, я всегда буду рядом.",
