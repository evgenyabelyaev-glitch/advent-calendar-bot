...
ADVENT_MESSAGES = {
    ...
    22: "❄️😢Похолодало! И твои слезки, которые ты зачем-то проронила в субботу в доме замерзли и я решил пока их повесить над окошком. Давай сделаем так, чтобы у нас с тобой были только эти слезки и мы доставали их всего раз в год♥️",
