...
ADVENT_MESSAGES = {
    ...
    15: "🔥Твои руки - это мой дом. В них тепло и безопасно. Давай при следующей встрече подержимся за руки чуть дольше, чем обычно🧤",
    16: "💪 Ты сильная! Сегодня вспомни и напиши мне одну свою самую большую победу этого года. Это не обязательно что-то огромное, может быть, ты просто пережила сложный день. Знай, что ты невероятно сильная, и я это вижу💖",
    17: "",
    18: "",
    19: "",
    20: "",
